...
public class B_ShopBuyer extends Script {
   ...
   public B_ShopBuyer(Extension e) {
       super(e);
   }
           ...
           if (isQuestMenu()) {
               if (menu == -1) {
                   ...
                   for (int i = 0; i < questMenuCount(); ++i) {
                       ...
                       if (option.contains("sell") || option.contains("yes please") || option.contains("see your wares") || option.contains("see what you've got")) {
                           menu = i;
                           return 10;
                       }
                   }
   ...
   public void paint() {
       int x = 110;
       int y = 10;
       drawString("Blood Shop Buyer", x, y, 2, 0xFFFFFF);
       y += 12;
   ...
   public void onServerMessage(String s) {
       s = s.toLowerCase();
       if (s.contains("store") || s.contains("hello") || s.contains("welcome") || s.contains("buy") || s.contains("how can i help")) {
           answering = System.currentTimeMillis();
           return;
       }
       if (s.contains("you don't have enough money")) {
           takeScreenshot(System.currentTimeMillis() + "-B_ShopBuyer");
