...
public final class S_Miner extends Script
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (command.equals("OK")) {
            if (frame.equals(_getWindow((Component) e.getSource()))) {
                try {
    ...
    public void onServerMessage(String str) {
        ...
        if (str.contains("standing here")) {
            ...
            _printOut();
            lvl_time = System.currentTimeMillis() + 4000L;
            cur_fails = 0;
            cur_success = 0;
            ++levels_gained;
        } else if (str.contains("manage") || str.contains("gem") || str.contains("just mined") || str.contains("found")) {
            click_time = System.currentTimeMillis() + random(100, 200);
            ++cur_success;
            ++total_success;
