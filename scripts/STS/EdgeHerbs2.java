public class EdgeHerbs2 extends Methods
{
    public EdgeHerbs2(mudclient mc){super(mc);}
    public int foodid;
    ...
    int[] UnidedHerbs = {439,442,441,42,33,522,593};
    int[] IdedHerbs = {439,442,441,42,33,522,593};
    LockMode(fmode);
    AutoLogin(true);
    Display("EdgeVille wild Herbs by @cya@OMFG");
    Display("Authname: " + GetAuthName() + " is valid, you may use the script.");
